...
using MixingApp.Services.SpotifyWeb.Models;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading;
using System.Threading.Tasks;
using MixingApp.ViewModels.SpotifyWeb;
using MixingApp.Services.SpotifyWeb.Models.Enums;

namespace MixingApp.Services.SpotifyWeb
{
    ...
    public sealed class SpotifyWebAPI : IDisposable
    {
        ...
        {
            return <SearchItem>(_builder.SearchItems(q, type, limit, offset, market));
        }
